...
module.exports = "<button (click)=\"buttonClicked()\">Increase counter</button> {{counter | json}} \n<br>\n\n"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(storageService) {
        ...
        this.storeKey = "counter";
        var value = Number(this.storageService.getItemFromStore(this.storeKey));
        if (value)
            this.counter.value = value;
        this.storageService.changes.subscribe(function (item) {
            if (item.key == _this.storeKey) {
                debugger;
                _this.counter = JSON.parse(JSON.stringify({ value: item.value }));
            }
        });
    }
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_local_storage_service__WEBPACK_IMPORTED_MODULE_2__["StorageService"]])
    ], AppComponent);
    return AppComponent;
}());
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [_local_storage_service__WEBPACK_IMPORTED_MODULE_4__["StorageService"]],
...
/* harmony import */ var rxjs_add_operator_share__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/add/operator/share */ "./node_modules/rxjs-compat/_esm5/add/operator/share.js");
...
var StorageService = /** @class */ (function () {
    function StorageService() {
        this.onSubject = new rxjs_Subject__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
    ...
    StorageService.prototype.getItemFromStore = function (value) {
...
module.exports = __webpack_require__(/*! C:\WDX_GIT\localstorage-eventing\src\main.ts */"./src/main.ts");
